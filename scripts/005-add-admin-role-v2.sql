...
-- Drop ALL existing policies first (including admin policies)
...
DROP POLICY IF EXISTS "Admins can insert hotel images" ON hotel_images;
DROP POLICY IF EXISTS "Admins can update hotel images" ON hotel_images;
DROP POLICY IF EXISTS "Admins can delete hotel images" ON hotel_images;
